...
public class AStar {
	...
	public static List<Node> findPath(World world, Vector2i start, Vector2i end){
		...
		Node current = new Node(start,null,0,getDistance1(start,end));
		...
		while(openList.size() > 0) {
			...
			for(int i = 0; i < 9; i++) {
				...
				double gCost = current.gCost + getDistance1(current.tile,a);
				double hCost = getDistance1(a,end);
	...
	private static double getDistance1(Vector2i tile, Vector2i goal) {
